...
public class ProfileInfo {
	...
	private Map<Integer,ProfileInfo> profiles = new HashMap<Integer,ProfileInfo>();
	...
	public Map<Integer, ProfileInfo> getProfiles() {
		return profiles;
	}

	public void setProfiles(Map<Integer, ProfileInfo> profiles) {
